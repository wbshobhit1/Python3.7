...
class sayed_mustaq_ali:
    total_seasons = 15

    def __init__(self, team_name, tittle, latest_result):
        self.team_name = team_name
        self.tittle = tittle
        self.latest_result = latest_result

    def print_details(self):
        return f"Most successful team of this domestic tournament is  {self.team_name} & won {self.tittle} times" \
               f" and last season(2020-21) won by {self.latest_result}"


class Domestic(sayed_mustaq_ali, Ipl):
    pass
...
# Csk = Domestic("Chennai Super Kings", 3, "Ms Dhoni", [2010, 2011, 2018])
# print(Csk.print_details())
Tamilnadu = Domestic(["Karnataka", "Baroda", "tamilnadu"], 2, "tamilnadu")
print(Tamilnadu.print_details())
print("Season Number", end=" ")
print(Domestic.total_seasons)